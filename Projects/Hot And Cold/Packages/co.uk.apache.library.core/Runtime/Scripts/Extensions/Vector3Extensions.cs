...
namespace Apache.Core.Extensions {
	public static class Vector3Extensions {
		...
		/// <summary>
		/// Returns a <c>Vector3</c> with this <c>Vector3</c>'s <c>x</c>, <c>y</c>, and <c>z</c>components rounded to the nearest integer.
		/// </summary>
		...
		/// <summary>
		/// Returns a <c>Vector3</c> with this <c>Vector3</c>'s <c>x</c>, <c>y</c>, and <c>z</c> components rounded to the nearest given
		/// interval.</summary>
		public static Vector3 Round(this Vector3 self, float toNearest) {
			return self.Round(new Vector3(toNearest, toNearest, toNearest));
		}

		/// <summary>
		/// Returns a <c>Vector3</c> with this <c>Vector3</c>'s <c>x</c>, <c>y</c>, and <c>z</c> components rounded to the nearest given
		/// <c>Vector3</c>'s <c>x</c>, <c>y</c>, and <c>z</c> intervals.
		/// </summary>
		public static Vector3 Round(this Vector3 self, Vector3 toNearest) {
			self.x = self.x.Round(toNearest.x);
			self.y = self.y.Round(toNearest.y);
			self.z = self.z.Round(toNearest.z);
			return self;
		}
