...
namespace Apache.Core.Extensions {
	public static class Vector2Extensions {
		...
		/// <summary>Returns a <c>Vector2</c> with this <c>Vector2</c>'s <c>x</c> and <c>y</c> components rounded to the nearest integer.</summary>
		public static Vector2 Round(this Vector2 self) {
			return self.Round(1);
		}

		/// <summary>Returns a <c>Vector2</c> with this <c>Vector2</c>'s <c>x</c> and <c>y</c> components rounded to the nearest given interval.</summary>
		public static Vector2 Round(this Vector2 self, float toNearest) {
			return self.Round(new Vector2(toNearest, toNearest));
		}

		/// <summary>
		/// Returns a <c>Vector2</c> with this <c>Vector2</c>'s <c>x</c> and <c>y</c> components rounded to the nearest given <c>Vector2</c>'s <c>x</c>
		/// and <c>y</c> intervals.
		/// </summary>
		public static Vector2 Round(this Vector2 self, Vector2 toNearest) {
			self.x = self.x.Round(toNearest.x);
			self.y = self.y.Round(toNearest.y);
			return self;
		}
