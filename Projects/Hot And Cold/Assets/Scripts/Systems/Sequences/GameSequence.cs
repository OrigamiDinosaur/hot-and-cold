...
public class GameSequence {
	...
	public GameSequence(MonoBehaviour aMonoBehaviour) {
	...
	public GameSequence Do(float delay, Action action) {
	...
	/// <param name="action">The action to invoke.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence DoRealtime(float delay, Action action) {
		if (action == null) return this;
	...
	/// <param name="action">The action to invoke.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence Do(float delay, bool isRealtime, Action action) {
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence Coroutine(IEnumerator coroutine) {
	...
	/// <param name="action">The action to invoke.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence Queue(float delay, Action action) {
	...
	/// <param name="action">The action to invoke.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence QueueRealtime(float delay, Action action) {
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence Tween(LTDescr tween) {
	...
	/// <param name="tween">The tween to manage.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence TweenRealtime(LTDescr tween) {
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence NextFrame(Action action) {
		if (action == null) return this;
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence AfterFrames(int numFrames, Action action) {
		if (action == null) return this;
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence EachFrame(Func<bool> func) {
	...
	/// <param name="action">The action to be performed in the determined frame.</param>
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence EndOfFrame(Action action) {
		if (action == null) return this;
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence EachEndOfFrame(Func<bool> func) {
		if (func == null) return this;
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence FixedUpdate(Action action) {
		if (action == null) return this;
	...
	/// <returns>This instance, useful for chaining.</returns>
	public GameSequence EachFixedUpdate(Func<bool> func) {
		if (func == null) return this;
